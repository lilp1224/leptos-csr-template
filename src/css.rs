        ...
        match theme {
            Theme::Ig => {
                match self {
                    ...
                    CssClass::NotFoundPageContainer => "m-auto text-center p-20 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-lg shadow-xl",
                    CssClass::NotFoundPageH1 => "text-9xl font-bold text-white mb-8",
                    CssClass::NotFoundPageP => "text-2xl text-white mb-8",
                    CssClass::NotFoundPageA => "px-8 py-3 text-lg font-semibold rounded-full bg-white text-indigo-500 hover:bg-gray-200 transition-colors duration-300",
                }
            }
            Theme::Twitter => {
                match self {
                    ...
                    CssClass::NotFoundPageContainer => "flex flex-col items-center justify-center h-screen bg-blue-50",
                    CssClass::NotFoundPageH1 => "text-6xl font-bold text-blue-600 mb-8",
                    CssClass::NotFoundPageP => "text-xl text-blue-600 mb-8",
                    CssClass::NotFoundPageA => "px-8 py-3 text-lg font-semibold rounded-full bg-white text-blue-500 hover:bg-gray-200 transition-colors duration-300",
                }
            }
        }
    }
